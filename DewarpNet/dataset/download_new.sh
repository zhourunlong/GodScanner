#!/bin/bash
if [ "$#" -eq 1 ]; then
    outputPath="$1/data2/shenrui/Downloads/doc3d"
else
    outputPath="$1/data2/shenrui/Downloads/doc3d"
fi
...
doc3d_download(){
    ...
    local path=$2
    local files=$3
    local uname=anmorui@foxmail.com   # put your username
    local pass=X0Ty1qQeMM     # put your password
